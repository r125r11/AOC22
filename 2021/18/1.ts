...
console.log(calc(func(input.split(/\r?\n/))))

console.log('calc',calc('[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]'))

// console.log('explode',explode('[[6,[5,[4,[3,2]]]],1]'.split(''),10))
// console.log('add',sum('[1,2]','[[3,4],5]'))
// console.log('split', separate('[[[[0,7],4],[[7,8],[0,13]]],[1,1]]'.split(/([0-9]{1,2}|\,|\[|\])/g).filter(val => val !== ''), 22))
// console.log('[[[[0,7],4],[[7,8],[0,13]]],[1,1]]'.split(/([0-9]{1,2}|\,|\[|\])/g).filter(val => val !== ''))
